-- Add default fee structure for seminar id 4
SET @seminar_id = 4;
...
(@seminar_id, 'Spot', 'On-site registration', '2026-04-01', '2026-12-31');
...
SET @slab_spot = (SELECT id FROM fee_slabs WHERE seminar_id = @seminar_id AND label = 'Spot');
